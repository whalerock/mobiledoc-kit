define('tests/acceptance/basic-editor-test', ['exports', 'mobiledoc-kit', '../test-helpers', 'mobiledoc-kit/utils/cursor/range', 'mobiledoc-kit/utils/cursor/position', 'mobiledoc-kit/utils/characters'], function (exports, _mobiledocKit, _testHelpers, _mobiledocKitUtilsCursorRange, _mobiledocKitUtilsCursorPosition, _mobiledocKitUtilsCharacters) {
  'use strict';
  ...
  test('select-all and type text works ok', function (assert) {
    ...
    _testHelpers['default'].dom.moveCursorTo(editor, editorElement.firstChild, 0);
    var post = editor.post;
    editor.selectRange(new _mobiledocKitUtilsCursorRange['default'](post.headPosition(), post.tailPosition()));
  ...
  test('typing enter splits lines, sets cursor', function (assert) {
    ...
    _testHelpers['default'].dom.moveCursorTo(editor, $('#editor p')[0].firstChild, 2);
...
define('tests/acceptance/editor-cards-test', ['exports', 'mobiledoc-kit', 'mobiledoc-kit/utils/key', 'mobiledoc-kit/utils/cursor/range', '../test-helpers', 'mobiledoc-kit/models/card'], function (exports, _mobiledocKit, _mobiledocKitUtilsKey, _mobiledocKitUtilsCursorRange, _testHelpers, _mobiledocKitModelsCard) {
  ...
  test('selecting a card and some text after and deleting deletes card and text', function (assert) {
    ...
    _testHelpers['default'].dom.moveCursorTo(editor, editorElement.firstChild.firstChild, 0, editorElement.lastChild.firstChild, 1);
    _testHelpers['default'].dom.triggerDelete(editor);
...
define('tests/acceptance/editor-copy-paste-test', ['exports', 'mobiledoc-kit', '../test-helpers', 'mobiledoc-kit/utils/cursor/range', 'mobiledoc-kit/utils/parse-utils', 'mobiledoc-kit/utils/keycodes'], function (exports, _mobiledocKit, _testHelpers, _mobiledocKitUtilsCursorRange, _mobiledocKitUtilsParseUtils, _mobiledocKitUtilsKeycodes) {
  'use strict';
  ...
  test('pasting when cursor is on left/right side of card adds content before/after card', function (assert) {
    ...
    _testHelpers['default'].dom.setCopyData(_mobiledocKitUtilsParseUtils.MIME_TEXT_PLAIN, 'abc');
    editor.selectRange(new _mobiledocKitUtilsCursorRange['default'](card.headPosition()));
    _testHelpers['default'].dom.triggerPasteEvent(editor);
    ...
    editor.selectRange(new _mobiledocKitUtilsCursorRange['default'](card.tailPosition()));
    _testHelpers['default'].dom.triggerPasteEvent(editor);
...
define('tests/acceptance/editor-input-handlers-test', ['exports', '../test-helpers', 'mobiledoc-kit/utils/cursor/range', 'mobiledoc-kit/renderers/editor-dom'], function (exports, _testHelpers, _mobiledocKitUtilsCursorRange, _mobiledocKitRenderersEditorDom) {
  'use strict';
  ...
  test('an input handler will trigger anywhere in the text', function (assert) {
    ...
    // middle
    editor.selectRange(_mobiledocKitUtilsCursorRange['default'].create(editor.post.sections.head, '@'.length + 1 + 'ab'.length));
    _testHelpers['default'].dom.insertText(editor, '@');
  ...
  test('an input handler can provide a `match` instead of `text`', function (assert) {
    ...
    // middle
    editor.selectRange(_mobiledocKitUtilsCursorRange['default'].create(editor.post.sections.head, 'abX'.length + 1 + 'ab'.length));
    _testHelpers['default'].dom.insertText(editor, '..X');
    assert.equal(expandCount, 2, 'expansion was run at middle');
  ...
  test('an input handler can provide a `match` that matches at start and end', function (assert) {
    ...
    // middle
    editor.selectRange(_mobiledocKitUtilsCursorRange['default'].create(editor.post.sections.head, '123'.length + 2));
    _testHelpers['default'].dom.insertText(editor, '123');
...
define('tests/acceptance/editor-key-commands-test', ['exports', 'mobiledoc-kit/utils/key', 'mobiledoc-kit/utils/keycodes', 'mobiledoc-kit/utils/browser', '../test-helpers', 'mobiledoc-kit/utils/cursor/range'], function (exports, _mobiledocKitUtilsKey, _mobiledocKitUtilsKeycodes, _mobiledocKitUtilsBrowser, _testHelpers, _mobiledocKitUtilsCursorRange) {
  'use strict';
  ...
  function renderIntoAndFocusTail(treeFn) {
    var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

    var editor = _testHelpers['default'].mobiledoc.renderInto(editorElement, treeFn, options);
    editor.selectRange(new _mobiledocKitUtilsCursorRange['default'](editor.post.tailPosition()));
    return editor;
  }
  ...
  function testStatefulCommand(_ref) {
    ...
    test(command + ' applies markup ' + markupName + ' to highlighted text', function (assert) {
      ...
      editor = renderIntoAndFocusTail(function (_ref2) {
        var post = _ref2.post;
        var markupSection = _ref2.markupSection;
        var marker = _ref2.marker;
    ...
    test(command + ' toggles ' + markupName + ' for next entered text', function (assert) {
      ...
      editor = renderIntoAndFocusTail(function (_ref3) {
        var post = _ref3.post;
        var markupSection = _ref3.markupSection;
        var marker = _ref3.marker;
        return post([markupSection('p', [marker(initialText)])]);
  ...
  test('cmd-left goes to the beginning of a line (MacOS only)', function (assert) {
    var initialText = 'something';
    editor = renderIntoAndFocusTail(function (_ref6) {
      var post = _ref6.post;
      var markupSection = _ref6.markupSection;
      var marker = _ref6.marker;
      return post([markupSection('p', [marker(initialText)])]);
    ...
    var originalCursorPosition = _testHelpers['default'].dom.getCursorPosition();
    _testHelpers['default'].dom.triggerKeyCommand(editor, 'LEFT', _mobiledocKitUtilsKey.MODIFIERS.META);

    var changedCursorPosition = _testHelpers['default'].dom.getCursorPosition();
    var expectedCursorPosition = 0; // beginning of text
  ...
  test('cmd-right goes to the end of a line (MacOS only)', function (assert) {
    var initialText = 'something';
    editor = renderIntoAndFocusTail(function (_ref7) {
      var post = _ref7.post;
      var markupSection = _ref7.markupSection;
      var marker = _ref7.marker;
      return post([markupSection('p', [marker(initialText)])]);
    ...
    _testHelpers['default'].dom.moveCursorTo(editor, textElement, 4);
    var originalCursorPosition = _testHelpers['default'].dom.getCursorPosition();
    _testHelpers['default'].dom.triggerKeyCommand(editor, 'RIGHT', _mobiledocKitUtilsKey.MODIFIERS.META);

    var changedCursorPosition = _testHelpers['default'].dom.getCursorPosition();
    var expectedCursorPosition = initialText.length; // end of text
  ...
  test('ctrl-k clears to the end of a line', function (assert) {
    var initialText = 'something';
    editor = renderIntoAndFocusTail(function (_ref8) {
      var post = _ref8.post;
      var markupSection = _ref8.markupSection;
      var marker = _ref8.marker;
      return post([markupSection('p', [marker(initialText)])]);
  ...
  test('ctrl-k clears selected text', function (assert) {
    var initialText = 'something';
    editor = renderIntoAndFocusTail(function (_ref10) {
      var post = _ref10.post;
      var markupSection = _ref10.markupSection;
      var marker = _ref10.marker;
      return post([markupSection('p', [marker(initialText)])]);
    ...
    var changedMobiledoc = editor.serialize();
    var expectedMobiledoc = _testHelpers['default'].mobiledoc.build(function (_ref11) {
      var post = _ref11.post;
      var markupSection = _ref11.markupSection;
      var marker = _ref11.marker;
  ...
  test('cmd-k links selected text', function (assert) {
    ...
    editor = renderIntoAndFocusTail(function (_ref12) {
      var post = _ref12.post;
      var markupSection = _ref12.markupSection;
      var marker = _ref12.marker;
  ...
  test('cmd-k unlinks selected text if it was already linked', function (assert) {
    ...
    var url = 'http://bustle.com';
    editor = renderIntoAndFocusTail(function (_ref13) {
      var post = _ref13.post;
      var markupSection = _ref13.markupSection;
      var marker = _ref13.marker;
  ...
  test('new key commands can be registered', function (assert) {
    editor = renderIntoAndFocusTail(function (_ref14) {
      var post = _ref14.post;
      var markupSection = _ref14.markupSection;
      var marker = _ref14.marker;
      return post([markupSection('p', [marker('something')])]);
  ...
  test('new key commands can be registered without modifiers', function (assert) {
    editor = renderIntoAndFocusTail(function (_ref15) {
      var post = _ref15.post;
      var markupSection = _ref15.markupSection;
      var marker = _ref15.marker;
      return post([markupSection('p', [marker('something')])]);
  ...
  test('duplicate key commands can be registered with the last registered winning', function (assert) {
    editor = renderIntoAndFocusTail(function (_ref16) {
      var post = _ref16.post;
      var markupSection = _ref16.markupSection;
      var marker = _ref16.marker;
      return post([markupSection('p', [marker('something')])]);
  ...
  test('returning false from key command causes next match to run', function (assert) {
    editor = renderIntoAndFocusTail(function (_ref17) {
      var post = _ref17.post;
      var markupSection = _ref17.markupSection;
      var marker = _ref17.marker;
      return post([markupSection('p', [marker('something')])]);
  ...
  test('key commands can override built-in functionality', function (assert) {
    editor = renderIntoAndFocusTail(function (_ref18) {
      var post = _ref18.post;
      var markupSection = _ref18.markupSection;
      var marker = _ref18.marker;
      return post([markupSection('p', [marker('something')])]);
  ...
  test('returning false from key command still runs built-in functionality', function (assert) {
    editor = renderIntoAndFocusTail(function (_ref19) {
...
define('tests/acceptance/editor-sections-test', ['exports', 'mobiledoc-kit', '../test-helpers', 'mobiledoc-kit/renderers/mobiledoc/0-2', 'mobiledoc-kit/renderers/editor-dom', 'mobiledoc-kit/utils/cursor/range'], function (exports, _mobiledocKit, _testHelpers, _mobiledocKitRenderersMobiledoc02, _mobiledocKitRenderersEditorDom, _mobiledocKitUtilsCursorRange) {
  'use strict';
...
define('tests/acceptance/editor-selections-test', ['exports', 'mobiledoc-kit', '../test-helpers', 'mobiledoc-kit/renderers/mobiledoc/0-2'], function (exports, _mobiledocKit, _testHelpers, _mobiledocKitRenderersMobiledoc02) {
  ...
  test('when editing is disabled, the selection detection code is disabled', function (assert) {
    ...
    var firstSection = $('p:contains(one trick pony)')[0];
    var outsideSection = $('p:contains(outside section)')[0];

    _testHelpers['default'].dom.selectText(editor, 'trick', firstSection, 'outside', outsideSection);
...
define('tests/acceptance/editor-undo-redo-test', ['exports', 'mobiledoc-kit/utils/key', '../test-helpers', 'mobiledoc-kit/utils/cursor/position', 'mobiledoc-kit/utils/cursor/range'], function (exports, _mobiledocKitUtilsKey, _testHelpers, _mobiledocKitUtilsCursorPosition, _mobiledocKitUtilsCursorRange) {
  'use strict';
  ...
  test('undo/redo the insertion of a character', function (assert) {
    ...
    editor = renderIntoAndFocusTail(function (_ref) {
      var post = _ref.post;
      var markupSection = _ref.markupSection;
      var marker = _ref.marker;
  ...
  test('undo the deletion of a range', function (assert) {
    var expectedBeforeUndo = undefined,
        expectedAfterUndo = undefined;
    editor = renderIntoAndFocusTail(function (_ref4) {
      var post = _ref4.post;
      var markupSection = _ref4.markupSection;
      var marker = _ref4.marker;
  ...
  test('undo insertion of character to a list item', function (assert) {
    ...
    var expectedBeforeUndo = undefined,
        expectedAfterUndo = undefined;
    editor = renderIntoAndFocusTail(function (_ref5) {
      var post = _ref5.post;
      var listSection = _ref5.listSection;
      var listItem = _ref5.listItem;
      var marker = _ref5.marker;
  ...
  test('take and undo a snapshot based on drag/dropping of text', function (assert) {
    ...
    var beforeUndo = undefined,
        afterUndo = undefined;
    editor = renderIntoAndFocusTail(function (_ref9) {
      var post = _ref9.post;
      var markupSection = _ref9.markupSection;
      var marker = _ref9.marker;
  ...
  test('take and undo a snapshot when removing an atom', function (assert) {
    ...
    var beforeUndo = undefined,
        afterUndo = undefined;
    editor = renderIntoAndFocusTail(function (_ref11) {
      var post = _ref11.post;
      var markupSection = _ref11.markupSection;
      var marker = _ref11.marker;
      var atom = _ref11.atom;
...
QUnit.module('JSHint - tests/jshint/js/editor');
QUnit.test('tests/jshint/js/editor/text-expansion-handler.js should pass jshint', function(assert) { 
  assert.ok(true, 'tests/jshint/js/editor/text-expansion-handler.js should pass jshint.'); 
});
...
define('tests/test-helpers', ['exports', './helpers/assertions', './helpers/dom', './helpers/mobiledoc', './helpers/post-abstract', './helpers/browsers'], function (exports, _helpersAssertions, _helpersDom, _helpersMobiledoc, _helpersPostAbstract, _helpersBrowsers) {
  'use strict';
...
define('tests/unit/editor/editor-events-test', ['exports', '../../test-helpers', 'mobiledoc-kit', 'mobiledoc-kit/utils/cursor/range'], function (exports, _testHelpers, _mobiledocKit, _mobiledocKitUtilsCursorRange) {
  ...
  test('cursorDidChange callback fired after mouseup', function (assert) {
    assert.expect(2);
    var done = assert.async();
    ...
    _testHelpers['default'].dom.moveCursorWithoutNotifyingEditorTo(editor, node, 0);
  ...
  test('cursorDidChange callback not fired after mouseup when selection is unchanged', function (assert) {
    assert.expect(2);
    var done = assert.async();
  ...
  test('cursorDidChange callback fired after mouseup when editor loses focus', function (assert) {
    assert.expect(2);
    var done = assert.async();
    ...
    _testHelpers['default'].dom.moveCursorWithoutNotifyingEditorTo(editor, node);
  ...
  test('cursorDidChange callback fired after keypress', function (assert) {
    var done = assert.async();
    assert.expect(2);
    ...
    _testHelpers['default'].dom.moveCursorWithoutNotifyingEditorTo(editor, node, 'this is the editor'.length);
    _testHelpers['default'].dom.triggerRightArrowKey(editor);
  ...
  test('inputModeDidChange callback fired when markup is toggled and there is no selection', function (assert) {
    var done = assert.async();
    assert.expect(1);
...
define('tests/unit/models/post-test', ['exports', '../../test-helpers', 'mobiledoc-kit/utils/cursor/range', 'mobiledoc-kit/utils/cursor/position'], function (exports, _testHelpers, _mobiledocKitUtilsCursorRange, _mobiledocKitUtilsCursorPosition) {
  ...
  test('#trimTo creates a post from the given range', function (assert) {
    ...
    var expected = _testHelpers['default'].postAbstract.build(function (_ref13) {
      var post = _ref13.post;
      var marker = _ref13.marker;
      var markupSection = _ref13.markupSection;
  ...
  test('#trimTo copies card sections', function (assert) {
    ...
    post = post.trimTo(range);
    var expected = buildPost(function (_ref15) {
      var post = _ref15.post;
      var marker = _ref15.marker;
      var markupSection = _ref15.markupSection;
      var cardSection = _ref15.cardSection;
  ...
  test('#trimTo when range starts and ends in a list item', function (assert) {
    ...
    post = post.trimTo(range);
    var expected = buildPost(function (_ref17) {
      var post = _ref17.post;
      var listSection = _ref17.listSection;
      var listItem = _ref17.listItem;
      var marker = _ref17.marker;
  ...
  test('#trimTo when range contains multiple list items', function (assert) {
    ...
    post = post.trimTo(range);
    var expected = buildPost(function (_ref19) {
      var post = _ref19.post;
  ...
  test('#trimTo when range contains multiple list items and more sections', function (assert) {
    ...
    post = post.trimTo(range);
    var expected = buildPost(function (_ref21) {
      var post = _ref21.post;
      var listSection = _ref21.listSection;
      var listItem = _ref21.listItem;
      var markupSection = _ref21.markupSection;
...
define('tests/unit/utils/key-test', ['exports', '../../test-helpers', 'mobiledoc-kit/utils/key', 'mobiledoc-kit/utils/keycodes'], function (exports, _testHelpers, _mobiledocKitUtilsKey, _mobiledocKitUtilsKeycodes) {
  ...
  test('HOME key is movement', function (assert) {
    var element = $('#qunit-fixture')[0];
    var event = _testHelpers['default'].dom.createMockEvent('keypress', element, {
      keyCode: _mobiledocKitUtilsKeycodes['default'].HOME,
      charCode: 0
    });
    var key = _mobiledocKitUtilsKey['default'].fromEvent(event);
  ...
  test('END key is movement', function (assert) {
    var element = $('#qunit-fixture')[0];
    var event = _testHelpers['default'].dom.createMockEvent('keypress', element, {
      keyCode: _mobiledocKitUtilsKeycodes['default'].END,
      charCode: 0
    });
    var key = _mobiledocKitUtilsKey['default'].fromEvent(event);
    assert.ok(key.isMovement());
