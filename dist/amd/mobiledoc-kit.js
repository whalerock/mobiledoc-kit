...
define('mobiledoc-kit/models/markup-section', ['exports', 'mobiledoc-kit/models/_markerable', 'mobiledoc-kit/utils/dom-utils', 'mobiledoc-kit/utils/array-utils', 'mobiledoc-kit/models/types'], function (exports, _mobiledocKitModels_markerable, _mobiledocKitUtilsDomUtils, _mobiledocKitUtilsArrayUtils, _mobiledocKitModelsTypes) {
  ...
  var VALID_MARKUP_SECTION_TAGNAMES = ['p', 'h3', 'h2', 'h1', 'header1Left', 'header1Center', 'header1Right', 'header2Left', 'header2Center', 'header2Right', 'header3Left', 'header3Center', 'header3Right', 'header4Left', 'header4Center', 'header4Right', 'header5Center', 'header6Left', 'header6Center', 'header6Right', 'subheader1Left', 'subheader1Center', 'subheader1Right', 'subheader2Left', 'subheader2Center', 'subheader2Right', 'subheader3Left', 'subheader3Center', 'subheader3Right', 'subheader4Center', 'body1Left', 'body1Right', 'body1Center', 'body2Left', 'body2Right', 'body2Center', 'body3Left', 'body3Right', 'body3Center', 'body4Left', 'body4Right', 'body4Center', 'blockquote1', 'blockquote2', 'blockquote', 'pull-quote'].map(_mobiledocKitUtilsDomUtils.normalizeTagName);
  ...
  // tagName
  var MARKUP_SECTION_ELEMENT_NAMES = ['p', 'h3', 'h2', 'h1', 'header1Left', 'header1Center', 'header1Right', 'header2Left', 'header2Center', 'header2Right', 'header3Left', 'header3Center', 'header3Right', 'header4Left', 'header4Center', 'header4Right', 'header5Center', 'header6Left', 'header6Center', 'header6Right', 'subheader1Left', 'subheader1Center', 'subheader1Right', 'subheader2Left', 'subheader2Center', 'subheader2Right', 'subheader3Left', 'subheader3Center', 'subheader3Right', 'subheader4Center', 'body1Left', 'body1Right', 'body1Center', 'body2Left', 'body2Right', 'body2Center', 'body3Left', 'body3Right', 'body3Center', 'body4Left', 'body4Right', 'body4Center', 'blockquote1', 'blockquote2', 'blockquote', 'pull-quote'].map(_mobiledocKitUtilsDomUtils.normalizeTagName);
