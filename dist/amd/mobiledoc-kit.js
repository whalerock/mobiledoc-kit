...
define('mobiledoc-kit/models/markup-section', ['exports', 'mobiledoc-kit/models/_markerable', 'mobiledoc-kit/utils/dom-utils', 'mobiledoc-kit/utils/array-utils', 'mobiledoc-kit/models/types'], function (exports, _mobiledocKitModels_markerable, _mobiledocKitUtilsDomUtils, _mobiledocKitUtilsArrayUtils, _mobiledocKitModelsTypes) {
  ...
  var VALID_MARKUP_SECTION_TAGNAMES = ['p', 'h3', 'h2', 'h1', 'header1-left', 'header1-center', 'header1-right', 'header2-left', 'header2-center', 'header2-right', 'header3-left', 'header3-center', 'header3-right', 'header4-left', 'header4-center', 'header4-right', 'header5-center', 'header6-left', 'header6-center', 'header6-right', 'subheader1-left', 'subheader1-center', 'subheader1-right', 'subheader2-left', 'subheader2-center', 'subheader2-right', 'subheader3-left', 'subheader3-center', 'subheader3-right', 'subheader4-center', 'body1-left', 'body1-right', 'body1-center', 'body2-left', 'body2-right', 'body2-center', 'body3-left', 'body3-right', 'body3-center', 'body4-left', 'body4-right', 'body4-center', 'header1', 'header2', 'header3', 'header4', 'header5', 'header6', 'subheader1', 'subheader2', 'subheader3', 'subheader4', 'body1', 'body2', 'body3', 'body4', 'blockquote1', 'blockquote2', 'blockquote', 'pull-quote'].map(_mobiledocKitUtilsDomUtils.normalizeTagName);
